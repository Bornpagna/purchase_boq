...
@endsection
@section('content')
<form class="priveiw-boq-form form-horizontal" method="POST"  enctype="multipart/form-data" action="{{url('boqs/uploadBoqPreview')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="zone_id" id="boq-zone" class="form-control boq-zone my-select2">
                                                <option value=""></option>
                                                {{getSystemDataVal('ZN',$request['zone_id'])}}
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="block_id" id="boq-block" class="form-control boq-block my-select2">
                                                <option value=""></option>
                                                {{getSystemDataVal('BK',$request['block_id'])}}
                                            </select>
                                            <span class="help-block font-red bold"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="building_id" id="boq-building" class="form-control boq-building my-select2">
                                                <option value=""></option>
                                                {{getSystemDataVal('BD',$request['building_id'])}}
                                            </select>
                                            <span class="help-block font-red bold"></span>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="house_type" id="boq-house-type" class="form-control boq-house-type my-select2">
                                                <option value=""></option>
                                                {{getSystemDataVal('HT',$request['house_type_id'])}}
                                            </select>
                                            <span class="help-block font-red bold"></span>
                                        </div>
                                    </div>
