				...
				<table class="table table-striped table-bordered table-hover" id="my-table">
					<thead>
						<tr>
							...
							<th width="9%" class="text-center all">{{ trans('lang.sub_total') }}</th>
							<th width="9%" class="text-center all">{{ trans('lang.discount') }}</th>
							<th width="9%" class="text-center all">{{ trans('lang.grand_total') }}</th>
