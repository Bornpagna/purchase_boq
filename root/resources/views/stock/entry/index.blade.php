				...
				<table class="table table-striped table-bordered table-hover" id="my-table">
					<thead>
						<tr>
							...
							<th width="32%" class="text-center">{{ trans('lang.desc') }}</th>
...
<script type="text/javascript">	
        ...
        str += '<table class="table table-striped details-table table-responsive"  id="sub-'+d.id+'">';
            str += '<thead>';
                str += '<tr>';
                    ...
                    str += '<th style="width: 15%;">{{trans("lang.reference")}}</th>';
                str += '</tr>';
            str += '</thead>';
        str +='</table>';
        return str;
	...
	var tableColumns = [];
	tableColumns.push({className: 'details-control',orderable: false,searchable: false,data: null,defaultContent: ''});
	tableColumns.push({data: 'ref_no', class:'text-center', name:'ref_no'});
	tableColumns.push({data: 'trans_date', class:'text-center', name:'trans_date'});
	tableColumns.push({data: 'supplier', name:'supplier'});
	tableColumns.push({data: 'desc', name:'desc'});
	tableColumns.push({data: 'action', class :'text-center', orderable: false, searchable: false});
