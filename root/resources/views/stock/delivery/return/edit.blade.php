...
<script type="text/javascript">	
	...
	function GetItem(po_id) {
		return $.ajax({url:'{{url("/stock/redeliv/GetItem")}}',type:'GET',dataType:'json',data:{id:po_id},async:false}).responseJSON;
	}
	...
	function initTable(data){
		$("#table-income tbody").append('<tr>'+
				...
				'</td>'+
				'<td>'+
				'	<input type="text" length="100" class="form-control line_reference line_reference_'+data.id+'" name="line_reference[]" value="'+isNullToString(data.note)+'"/>'+
				'</td>'+
			'</tr>');
