...
class CreateAlertQtyStockStoredProcedures extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      ...
      WHERE qb.stock_qty <= qb.new_alert_qty";
        \DB::unprepared("DROP PROCEDURE IF EXISTS AlertQTYStock; CREATE PROCEDURE AlertQTYStock(IN project int) BEGIN ({$sql}); END");
    }
    ...
    {
        \DB::unprepared("DROP PROCEDURE IF EXISTS AlertQTYStock;");
    }
}
