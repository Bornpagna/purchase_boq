...
class CreatePoApprovalStoredProcedures extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      ...
      WHERE AuthID IN (OWNER_USER, ADMIN) 
        ...
        \DB::unprepared("DROP PROCEDURE IF EXISTS POApproval; CREATE PROCEDURE POApproval(IN ProjectID int,IN AuthID int,IN OWNER_USER int,IN ADMIN int) BEGIN ({$sql}); END");
    }
    ...
    {
        \DB::unprepared("DROP PROCEDURE IF EXISTS POApproval;");
    }
}
